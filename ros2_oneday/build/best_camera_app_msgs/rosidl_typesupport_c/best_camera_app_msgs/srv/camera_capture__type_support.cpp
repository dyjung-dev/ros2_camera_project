...
#include "best_camera_app_msgs/srv/detail/camera_capture__type_support.h"
...
static const _CameraCapture_Request_type_support_symbol_names_t _CameraCapture_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, best_camera_app_msgs, srv, CameraCapture_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, best_camera_app_msgs, srv, CameraCapture_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, best_camera_app_msgs, srv, CameraCapture_Request)() {
  return &::best_camera_app_msgs::srv::rosidl_typesupport_c::CameraCapture_Request_message_type_support_handle;
}
...
static const _CameraCapture_Response_type_support_symbol_names_t _CameraCapture_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, best_camera_app_msgs, srv, CameraCapture_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, best_camera_app_msgs, srv, CameraCapture_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, best_camera_app_msgs, srv, CameraCapture_Response)() {
  return &::best_camera_app_msgs::srv::rosidl_typesupport_c::CameraCapture_Response_message_type_support_handle;
}
...
static const _CameraCapture_type_support_symbol_names_t _CameraCapture_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, best_camera_app_msgs, srv, CameraCapture)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, best_camera_app_msgs, srv, CameraCapture)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, best_camera_app_msgs, srv, CameraCapture)() {
  return &::best_camera_app_msgs::srv::rosidl_typesupport_c::CameraCapture_service_type_support_handle;
}
